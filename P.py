...
for year in selected_years:
    ...
    fig = px.pie(grouped_data, values='COUNT', names='CATEGORIE', title=f'Répartition des {total_projects} projets par catégorie pour l\'année {year}', color='CATEGORIE', color_discrete_map=category_color_maphole=0.3)
    ...
    # Afficher uniquement le nombre de projets dans le camembert
    fig.update_traces(textinfo='value', text=grouped_data['COUNT'], textposition='inside', insidetextfont=dict(size=16))
