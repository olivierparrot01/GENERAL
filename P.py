...
for year in selected_years:
    ...
    fig = px.pie(grouped_data,names='CATEGORIE', title=f'Répartition des {total_projects} projets par catégorie pour l\'année {year}', color='CATEGORIE', color_discrete_sequence=colors)
    ...
    fig.update_traces(texttemplate='%{value} (%{percent:.0%})')
