...
for year in selected_years:
    ...
    fig = px.pie(grouped_data, values='COUNT', names='CATEGORIE', title=f'Répartition des {total_ptojects} projets par catégorie pour l\'année {year}', color='CATEGORIE', color_discrete_map=category_color_map)
