...
for year in selected_years:
    ...
    fig = px.pie(grouped_data,names='CATEGORIE', title=f'Répartition des projets par catégorie pour l\'année {year}', color='CATEGORIE', color_discrete_sequence=colors)
