...
st.markdown("<h2 style='font-size:18px;'>Filtrer le fichier de géocodage par type de réponse de l'API et score</h2>", unsafe_allow_html=True)
st.markdown("<center><h2 style='font-size:16px;'>Le filtre n'est pas obligatoire<br></h2></center>", unsafe_allow_html=True)
st.markdown("<center><h2 style='font-size:16px;'>Il s'applique tout le long</h2></center>", unsafe_allow_html=True)
