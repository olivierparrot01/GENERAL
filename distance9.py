...
st.markdown("<h2 style='font-size:18px;'>Sélectionner par le Code AIOT les points Gun à mettre en évidence sur la carte<br>Sélection multiple, liens Google Maps individualisés</h2>", unsafe_allow_html=True)
