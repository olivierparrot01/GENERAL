...
selected_codes = st.sidebar.multiselect(f"Sélectionner parmi les {len(filtered_df)} données filtrées, les points Gun à mettre en évidence (sélection multiple possible)", sorted_codes)
