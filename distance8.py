...
if st.button(f"<span style='font-size:12px;'>Télécharger les données pour l'intervalle {selected_interval_left} to {selected_interval_right} (ICPE tout type)</span>", unsafe_allow_html=True):
