...
fig.add_trace(px.scatter_mapbox(filtered_df1, lat="latitude", lon="longitude", hover_data=["Nom_usuel","Adresse_concat","Code_AIOT"], size='nb_points', size_max=20, color_discrete_sequence=['blue']).data[0])
